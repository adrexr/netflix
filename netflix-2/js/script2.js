...
for (let i = 0; i < peliculas.length; i++) {
    divObjetos.append(
        ...
        <div class='carta-prueba'>
            ...
            <input type='hidden' id='imagen_siguiente' value='${peliculas[i].imagen_siguiente}'>
            <input type='hidden' id='nombre' value='${peliculas[i].nombre}'>
        </div>
        `
    )
}
...
cartaPrueba.click(
    function () {
        localStorage.image = $(this).children("#imagen_siguiente").val();
        localStorage.nombre_peli = $(this).children("#nombre").val();
        document.location.href = "./descripcion.html";
    }
)
